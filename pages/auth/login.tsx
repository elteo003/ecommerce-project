...
export default function LoginPage() {
  ...
  // forza logout all’arrivo sulla pagina
  useEffect(() => {
      ...
      >
        ...
        <label className="block mb-6 relative">
          ...
          <input
            ...
            required
            className="mt-1 block w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400 text-black pr-10"
          />
          <button
            type="button"
